...
#define my_httpd_logstats 6
extern  int * my_httpd_logstats_1(long *, CLIENT *);
extern  int * my_httpd_logstats_1_svc(long *, struct svc_req *);
...
#define my_httpd_logstats 6
extern  int * my_httpd_logstats_1();
extern  int * my_httpd_logstats_1_svc();
