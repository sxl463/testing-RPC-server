...
#define my_auth_check 1
extern  int * my_auth_check_1(shttpd_conn *, CLIENT *);
extern  int * my_auth_check_1_svc(shttpd_conn *, struct svc_req *);
...
#else /* K&R C */
#define my_auth_check 1
extern  int * my_auth_check_1();
extern  int * my_auth_check_1_svc();
#define read_alloc_count 2
